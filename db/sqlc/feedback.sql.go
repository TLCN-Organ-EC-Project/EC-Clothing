...
INSERT INTO feedbacks (
  ...
  $1, $2, $3, $4, $5
) RETURNING id, user_comment, product_commented, rating, commention, created_at
`
...
SELECT id, user_comment, product_commented, rating, commention, created_at FROM feedbacks
WHERE id = $1 LIMIT 1
`
...
func (q *Queries) ListFeedbacks(ctx context.Context, arg ListFeedbacksParams) ([]Feedback, error) {
	rows, err := q.db.QueryContext(ctx, listFeedbacks, arg.ProductCommented, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
