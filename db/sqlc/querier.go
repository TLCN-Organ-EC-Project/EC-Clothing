...
type Querier interface {
	...
	GetCartDetails(ctx context.Context, arg GetCartDetailsParams) (Cart, error)
	...
	GetOrderByDate(ctx context.Context, arg GetOrderByDateParams) (Order, error)
	...
	ListCartOfUser(ctx context.Context, arg ListCartOfUserParams) ([]Cart, error)
	...
	ListProductsNoLimit(ctx context.Context) ([]Product, error)
	...
	ListValidatedOrder(ctx context.Context, status string) ([]Order, error)
	StatisticsProduct(ctx context.Context) ([]StatisticsProductRow, error)
